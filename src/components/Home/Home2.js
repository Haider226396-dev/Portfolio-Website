        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              I am also passionate about developing products
              ...
              <br/>
              <br/>
              I also have strong expertise related to <b className="purple">Requirement Engineering </b>
              and I love to gather Requirements and transfrom these <b className="purple">Technical Requirements </b>
